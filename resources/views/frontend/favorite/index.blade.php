        ...
        <div class="container">
            <div class="row no-gutters slider-text align-items-center justify-content-center">
                <div class="col-md-9 ftco-animate text-center">
                    <p class="breadcrumbs"><span class="mr-2"><a href="index.html">Home</a></span> <span>Favorite</span></p>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td class="image-prod">
                                        <div class="img" style="background-image: url({{ $favorite->img_link }}) ;"></div>
                                    </td>
                                    ...
                                    <td class="price">{{ $favorite->price }}</td>
