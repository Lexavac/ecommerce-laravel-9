...
<html lang="en">
  <head>
    <title>TeBe Single Product</title>
    <meta charset="utf-8">
    ...
    <script type="text/javascript" src="https://platform-api.sharethis.com/js/sharethis.js#property=63640caa0e0d03001fe8c2bd&product=inline-share-buttons&source=platform" async="async"></script>
    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-lg-6 mb-5 ftco-animate">
    				<a href="images/menu-2.jpg" class="image-popup"><img src="{{ $product->gallery->first()->getUrl() }}" class="img-fluid" alt="Colorlib Template"></a>
    			</div>
    			...
    			<div class="col-lg-6 product-details pl-md-5 ftco-animate">
                    ...
                    <div id="shareBtn"><i class="uil uil-share-alt"></i></div>
    			...
    			@foreach($related_products as $related_product)
		    			<div class="col-sm-6 col-md-6 col-lg-4 d-flex justify-content-center ftco-animate">
		    				<div class="product justify-content-center">
		    					<a href="#" class="img-prod"><img class="img-fluid" src="{{ $related_product->gallery->first()->getUrl() }}" alt="Colorlib Template">
		    					...
		    					<div class="text py-3 px-3">
		    						...
		    						<div class="d-flex">
		    							<div class="pricing">
				    						<p class="price"><span class="mr-2 price-dc">$120.00</span><span class="price-sale">${{ $related_product->price }}</span></p>
				    					</div>
				    					<div class="rating">
			    							<p class="text-right">
			    								<a href="#"><span class="ion-ios-star-outline"></span></a>
