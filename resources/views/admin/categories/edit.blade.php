                ...
                <div class="card-body ">
                    <a href="{{ route('admin.categories.index') }}" class="btn btn-icon btn-info mb-3">
                        ...
                        <div class="col-12 col-md-6 col-lg-6">
                            ...
                            <form action="{{ route('admin.categories.update', $category->id) }}" method="POST" class="card-body">
                                @csrf
                                @method('put')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="desc" value="{{ old('desc', $category->desc) }}" class="form-control">
                                </div>
